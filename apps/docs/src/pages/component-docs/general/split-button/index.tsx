import { Text, Menu, MenuTrigger, MenuContent, MenuItem, Button } from "@hope-ui/solid";
...
import { PropsTableItem } from "@/components/PropsTable";
...
export default function IconButtonDoc() {
  ...
  return (
    ...
    >
      ...
      <Text mb="$8">
        SplitButton composes the <Code>Button</Code> component and <Code>Menu</Code> component as a
        Dropdown.
      </Text>
